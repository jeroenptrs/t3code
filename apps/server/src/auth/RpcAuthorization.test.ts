...
describe("RPC authorization scopes", () => {
  ...
  it("reads the reviewer menu under the same scope as the pull request it belongs to", () => {
    ...
    expect(requiredScopesForRpcMethod(WS_METHODS.pullRequestsReviewerCandidates)).toEqual(
      requiredScopesForRpcMethod(WS_METHODS.pullRequestsDetail),
    );
    expect(requiredScopesForRpcMethod(WS_METHODS.pullRequestsRequestReviewers)).toEqual(
      requiredScopesForRpcMethod(WS_METHODS.pullRequestsComment),
    );
  });
