...
const WsScheduledAutomationDispatchCommandRpc = Rpc.make(
...
const WsScheduledAutomationListRpc = Rpc.make(SCHEDULED_AUTOMATION_WS_METHODS.list, {
  payload: ScheduledAutomationRpcSchemas.list.input,
  success: ScheduledAutomationRpcSchemas.list.output,
  error: Schema.Union([ScheduledAutomationError, EnvironmentAuthorizationError]),
});

const WsScheduledAutomationGetRpc = Rpc.make(SCHEDULED_AUTOMATION_WS_METHODS.get, {
  payload: ScheduledAutomationRpcSchemas.get.input,
  success: ScheduledAutomationRpcSchemas.get.output,
  error: Schema.Union([ScheduledAutomationError, EnvironmentAuthorizationError]),
});

const WsScheduledAutomationSubscribeRpc = Rpc.make(SCHEDULED_AUTOMATION_WS_METHODS.subscribe, {
